          ...
          <tbody>
            ...
            <tr id="subscribe">
              ...
              <td v-if="locale=='en'">
                ...
                Microsoft Teams is not yet supported, while Yahoo is no longer supported. Both will be automatically disabled. The same applies to other Microsoft services on mobile devices.<br /><br />
              ...
              <td v-else>
                ...
                Microsoft Teams wird noch nicht unterstützt, während Yahoo nicht mehr unterstützt wird. Beide werden automatisch deaktiviert. Gleiches gilt für andere Microsoft-Dienste auf mobilen Geräten.<br /><br />
        ...
        <table>
          ...
          <tbody>
            ...
            <tr id="language">
              ...
              <td>
                <em>String</em><br /><br /><span class="label block">{{ $t('content.config.options') }}:</span>ar, az, be, bg, bs, cs, da, de, el, en, es, et, fa, fi, fr, he, hi, hr, hu, hy, id, it, ja, ka, ko, lt, lv, mk, mt, nl, no, pl, pt, ro, ru, sk, sl, sq, sr, sv, tr, uk, vi, zh<br /><br /><span
                  class="label"
                  >{{ $t('content.config.default') }}:</span
                >en
              </td>
              <td v-if="locale=='en'">
