        ...
        <table>
          ...
          <tbody>
            ...
            <tr id="language">
              ...
              <td>
                <em>String</em><br /><br /><span class="label block">{{ $t('content.config.options') }}:</span>ar, cs, de, en, es, et, fa, fi, fr, hi, hr, id, it, ja, ko, nl, no, ro, pl, pt, sv, tr, vi, zh , bg , da , el , hu , lt , mt , ru , sk , sl , sr<br /><br /><span class="label">{{ $t('content.config.default') }}:</span>en
              </td>
              <td v-if="locale=='en'">
