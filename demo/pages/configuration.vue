        ...
        <table>
          ...
          <tbody>
            ...
            <tr id="language">
              ...
              <td>
                <em>String</em><br /><br /><span class="label block">{{ $t('content.config.options') }}:</span>fa, ar, cs, de, en, es, fi, fr, hi, id, it, ja, ko, nl, no, ro, pl, pt, sv, tr, vi, zh<br /><br /><span class="label">{{ $t('content.config.default') }}:</span>en
              </td>
              <td v-if="locale=='en'">
