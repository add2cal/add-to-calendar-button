      ...
      <div :id="elID" class="autocomplete">
        <div class="focus-visible:ring-secondary/75 group mt-1 grid w-full cursor-default rounded-md bg-zinc-50 shadow hover:bg-white hover:shadow-md focus:outline-none focus-visible:ring dark:bg-zinc-700 dark:hover:bg-zinc-600">
          <input
            :id="elInputID"
            ref="searchInput"
            class="autocomplete-input caret-secondary focus-visible:ring-secondary/75 placeholder:text-xs truncate rounded-md bg-zinc-50 py-2 pl-3 pr-10 text-left text-sm focus:outline-none focus-visible:ring group-hover:bg-white dark:bg-zinc-700 dark:group-hover:bg-zinc-600"
