  ...
  <SwitchGroup>
    <div class="flex items-center py-2">
      ...
      <Switch
        ...
        class="relative inline-flex h-[24px] w-[40px] items-center rounded-full border border-zinc-300 shadow outline-none transition-colors hover:border-zinc-400 hover:shadow-md focus:outline-none focus-visible:ring focus-visible:ring-secondary/75 dark:border-zinc-500 dark:hover:border-zinc-400"
