<template>
  <div class="my-14 mx-auto grid max-w-sm grid-cols-1 gap-x-10 md:max-w-4xl md:grid-cols-[200px_minmax(0,1fr)] md:gap-y-20">
    ...
    <img :alt="$t('content.features.headline_2')" width="150" height="150" src="~/assets/img/variety.webp" class="mx-auto self-center" />
    <div class="mb-20 md:mb-0">
    ...
    <img :alt="$t('content.features.headline_3')" width="150" height="150" src="~/assets/img/style.webp" class="mx-auto self-center" />
    <div class="mb-20 md:mb-0">
    ...
    <img :alt="$t('content.features.headline_4')" width="150" height="150" src="~/assets/img/accessibility.webp" class="mx-auto self-center" />
    <div class="mb-20 md:mb-0">
    ...
    <img :alt="$t('content.features.headline_5')" width="150" height="150" src="~/assets/img/more.webp" class="mx-auto self-center" />
    <div>
