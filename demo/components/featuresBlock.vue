<template>
  <div class="mx-auto my-14 grid max-w-sm grid-cols-1 gap-x-10 md:max-w-4xl md:grid-cols-[200px_minmax(0,1fr)] md:gap-y-20">
    <nuxt-img placeholder loading="lazy" :alt="$t('content.features.headline_1')" width="150" height="150" src="/assets/img/caltypes.webp" class="mx-auto self-center" />
    ...
    <nuxt-img placeholder loading="lazy" :alt="$t('content.features.headline_4')" width="150" height="150" src="/assets/img/accessibility.webp" class="mx-auto self-center" />
    <div class="mb-20 md:mb-0">
    ...
    <nuxt-img placeholder loading="lazy" :alt="$t('content.features.headline_5')" width="150" height="150" src="/assets/img/more.webp" class="mx-auto self-center" />
    <div>
