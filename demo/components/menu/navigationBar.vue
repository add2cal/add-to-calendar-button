...
<template>
  ...
  <!-- mobile menu -->
  <nav :class="{ hidden: !showMM }" class="fixed left-0 top-0 z-50 h-full w-full overflow-y-auto bg-gradient-to-tr from-primary via-primary to-primary-dark dark:via-primary-dark dark:to-primary-dark" style="max-height: 100dvh;">
