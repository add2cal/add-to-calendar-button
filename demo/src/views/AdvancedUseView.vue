  ...
  <div class="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_192px]">
    <div class="pr-0 lg:pr-8 xl:pr-12 2xl:pr-20">
      ...
      <div v-else>
        ...
        <p>
          Sofern du die <RouterLink :to="{ name: 'examples', params: { locale } }">"{{ t('navigation.examples') }}"</RouterLink>-Seite noch nicht besucht hast, solltest du dies zuerst tun.
        </p>
      </div>
      <section id="1">
        ...
        <div v-else>
          ...
          <p>
            Prüfe die <RouterLink :to="{ name: 'configuration', params: { locale } }">"{{ t('navigation.configuration') }}"</RouterLink>-Seite für alle Einstellungs-Optionen und Funktionalitäten.
          </p>
