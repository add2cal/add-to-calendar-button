...
export default {
  ...
  render() {
    ...
    return h('div', { class: 'bg-gray-100 border-gray-300 dark:bg-zinc-900 dark:border-zinc-800 transition-colors border rounded-md', innerHTML: '<pre class="' + this.class + ' language-' + this.language + '"><code class="' + this.class + ' language-' + this.language + '">' + formattedCode + '</code></pre>' });
  },
  mounted() {
    Prism.highlightAll();
