...
- C-06: special tz alias (CET) -> Google gets the canonical location zone
...
- G-01: VCALENDAR structure with the calendarverse.org prodid using the stable semver (without a `-next*` suffix)
