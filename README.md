...
- Use "recurrence" to define recurring events. Use can use any valid [RRULE](https://www.rfc-editor.org/rfc/rfc5545) to define the respective rule. But mind that this will deactivate any Microsoft services, since they do not support it at the moment (users could still use iCal in this case).
