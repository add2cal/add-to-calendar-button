...
declare module 'add-to-calendar-button' {
  ...
  export function atcb_generate_timestring(dates: EventDate[], language?: string, subEvent?: string | number, browserTimeOverride?: boolean, enforceYear?: boolean): string[];
}
