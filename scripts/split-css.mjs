/**
 * One-time (and maintenance) CSS splitter for the v3 style architecture (phase 5).
 *
 * Reads the eight monolithic per-style stylesheets (assets/css/atcb*.css from v2)
