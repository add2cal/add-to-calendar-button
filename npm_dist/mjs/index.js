...
function atcb_generate_label(data, parent, type, icon = false, text = '', oneOption = false) {
  ...
  switch (type) {
    ...
    default:
      ...
      parent.classList.add('atcb-button-' + data.identifier);
    ...
    case 'Apple':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-apple');
      text = text || 'Apple';
      iconSvg =
    ...
    case 'Google':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-google');
      text = text || 'Google';
      iconSvg =
    ...
    case 'iCal':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-ical');
      text = text || 'iCal File';
      iconSvg =
    ...
    case 'MicrosoftTeams':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-msteams');
    ...
    case 'Microsoft365':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-ms365');
    ...
    case 'Outlook.com':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-outlook');
    ...
    case 'Yahoo':
      ...
      parent.classList.add('atcb-button-' + data.identifier + '-yahoo');
      text = text || 'Yahoo';
      iconSvg =
...
function atcb_toggle(data, button, keyboardTrigger = true, generatedButton = false) {
  ...
  if (button.classList.contains('atcb-active')) {
    atcb_close();
  } else {
