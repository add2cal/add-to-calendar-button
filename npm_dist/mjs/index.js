...
function atcb_generate_label(data, parent, type, icon = false, text = '', oneOption = false) {
  ...
  switch (type) {
    ...
    default:
      ...
      parent.setAttribute('id', 'atcb-btn-' + data.identifier);
    ...
    case 'MicrosoftTeams':
      ...
      parent.setAttribute('id', 'atcb-btn-' + data.identifier + '-msteams');
    ...
    case 'Microsoft365':
      ...
      parent.setAttribute('id', 'atcb-btn-' + data.identifier + '-ms365');
    ...
    case 'Outlook.com':
      ...
      parent.setAttribute('id', 'atcb-btn-' + data.identifier + '-outlook');
    ...
    case 'Yahoo':
      ...
      parent.setAttribute('id', 'atcb-btn-' + data.identifier + '-yahoo');
      text = text || 'Yahoo';
      iconSvg =
